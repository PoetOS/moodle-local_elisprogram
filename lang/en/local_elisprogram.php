...
$string['clear'] = 'Clear';
$string['clsenrolafterprgenrol_help'] = 'If enabled, this would enforce that User\'s Class Instance enrolment date must be after Program enrolment date for the Class to qualify as part of the Program\'s completion.';
$string['clsenrolafterprgenrol_setting'] = 'Class enrolment after Program enrolment';
...
$string['search_for'] = 'Saved search';
...
$string['incrementalgradesync_setting'] = 'Use incremental grade sync';
$string['incrementalgradesync_help'] = 'If enabled, grade sync will only sync grades that have been changed since it last ran. Enabling this can significantly speed up the grade sync process.';
...
$string['pm_certificate_date_format'] = '%B %e, %Y';
$string['pm_certificate_date_format_win'] = '%B %#d, %Y';
$string['pm_certificate_datetime_format'] = '%B %e, %Y %l:%M %p';
$string['pm_certificate_datetime_format_win'] = '%B %#d, %Y %l:%M %p';
