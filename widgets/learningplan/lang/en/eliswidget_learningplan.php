...
$string['setting_showincompletegrades'] = 'Always grades for incomplete classes';
$string['setting_showincompletegrades_description'] = 'Always show a user\'s current grade, even if the class is not yet complete.';
